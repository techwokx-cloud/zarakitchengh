    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm">
          Upload photos for the public Gallery page&apos;s Ambiance, Events, Drinks, and Happy Customers
          sections. (&quot;Our Food&quot; fills in automatically from your Menu, no upload needed there.)
        </p>
      </div>
      ...
      >
        {uploading ? (
          ...
          <>
            ...
            <p className="text-gray-500 text-xs mt-1">Uploading to: {CATEGORIES.find((c) => c.value === activeCategory)?.label}. You can select multiple files.</p>
          </>
        )}
        <input
          ref={fileInputRef}
