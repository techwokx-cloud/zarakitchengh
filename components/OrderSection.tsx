  ...
  return (
    <section className="py-12 px-4 bg-[#FFF8E7]">
      <div className="container-wide">
        {/* Order Your Way + Payments -- mockup asset used as-is */}
        <img
          src="/images/assets/order-your-way.png"
          alt="Order Your Way: Website, WhatsApp, Jumia Food, Uber Eats, Bolt Food, Hubtel. All Payments Accepted: Mobile Money, Bank Cards, Pay on Delivery."
